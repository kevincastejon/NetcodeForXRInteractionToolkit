...
namespace KevinCastejon.NetcodeForXRInteractionToolkit.Examples
{
    ...
    public class DistributedNetworkXRSimpleInteractable : DistributedAuthorityBehaviour
    {
        ...
        private XRSimpleInteractableConfigurable _xrSimpleinteractable;
        /// <summary>
        /// The XRSimpleInteractableConfigurable component to synchronise
        /// </summary>
        public XRSimpleInteractableConfigurable XRSimpleInteractable { get => _xrSimpleinteractable; }
        /// <summary>
        ...
        {
            _xrSimpleinteractable = GetComponent<XRSimpleInteractableConfigurable>();
        ...
        {
            if (_xrSimpleinteractable.AllowHoveredActivate || rpcParams.Receive.SenderClientId == OwnerClientId)
            {
